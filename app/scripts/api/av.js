...
(function(root) {
  ...
  _.extend(AV.Object.prototype, AV.Events,
    ...
    save: function(arg1, arg2, arg3) {
      ...
      if (unsavedChildren.length + unsavedFiles.length > 0) {
        return AV.Object._deepSaveAsync(this.attributes).then(function() {
  ...
  AV.Object._deepSaveAsync = function(object) {
    var unsavedChildren = [];
    var unsavedFiles = [];
...
(function(root) {
  ...
  /**
   * Creates a new parse AV.Query for the given AV.Object subclass.
   * @param objectClass -
  ...
  AV.Query.prototype = {
    ...
    find: function(options) {
      ...
      var request = AV._request("classes", this.className, null, "GET",
                                   this.toJSON());
